...
///
/// Note:
/// On linux, we use dbus to communicate multiple irisremote process.
...
const DBUS_NAME: &str = "org.irisremote.irisremote";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "IrisRemote DBus Error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=org.irisremote.irisremote /dbus org.irisremote.irisremote.NewConnection string:'PEER_ID'`

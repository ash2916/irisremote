...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the IrisRemote network..."),
        ...
        ("install_tip", "Due to UAC, IrisRemote can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install IrisRemote to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant IrisRemote \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant IrisRemote \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow IrisRemote to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [IrisRemote Input] service."),
        ...
        ("doc_mac_permission", "https://irisremote.com/docs/en/manual/mac/#enable-permissions"),
        ("doc_fix_wayland", "https://irisremote.com/docs/en/manual/linux/#x11-required"),
        ("server_not_support", "Not yet supported by the server"),
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next IrisRemote application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant IrisRemote \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running IrisRemote."),
        ("config_microphone", "In order to speak remotely, you need to grant IrisRemote \"Record Audio\" permissions."),
        ...
        ("install_cert_tip", "Install IrisRemote certificate"),
        ("confirm_install_cert_tip", "This is a IrisRemote testing certificate, which can be trusted. The certificate will be used to trust and install IrisRemote drivers when required."),
        ...
        ("enter_irisremote_passwd_tip", "Enter IrisRemote password"),
        ("remember_irisremote_passwd_tip", "Remember IrisRemote password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_irisremote_password_tip", "Verify IrisRemote password"),

...
void msgBox(SessionID sessionId, String type, String title, String text,
  ...
  submit() {
    dialogManager.dismissAll();
    // https://github.com/fufesou/irisremote/blob/5e9a31340b899822090a3731769ae79c6bf5f3e5/src/ui/common.tis#L263
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustDeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing IrisRemote...");
...
class ServerConfig {
  ...
  /// decode from shared string (from user shared or irisremote-server generated)
  /// also see [encode]
...
String getWindowName({WindowType? overrideType}) {
  switch (overrideType ?? kWindowType) {
    ...
    case WindowType.FileTransfer:
      return "File Transfer - IrisRemote";
    case WindowType.PortForward:
      return "Port Forward - IrisRemote";
    case WindowType.RemoteDesktop:
      return "Remote Desktop - IrisRemote";
    default:
      break;
  }
  return "IrisRemote";
...
const kMacOSPermChannel = MethodChannel("org.irisremote.irisremote/macos");

...
def write_metadata(md5_table: dict, output_folder: str, exe: str):
    ...
    with open(output_path, "wb") as f:
        f.write("irisremote".encode(encoding=encoding))
...
# Linux: python3 generate.py -f ../irisremote-portable-packer/test -o . -e ./test/main.py
# Windows: python3 .\generate.py -f ..\irisremote\flutter\build\windows\runner\Debug\ -o . -e ..\irisremote\flutter\build\windows\runner\Debug\irisremote.exe
